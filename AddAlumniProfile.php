...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check_query = "SELECT * FROM alumni_profile_table WHERE kld_email ='$kld_email' OR email='$email' OR alumni_id = '$alumni_id' LIMIT 1";
    $result = mysqli_query($conn, $check_query);
    if (mysqli_num_rows($result) > 0) {
        // If email or alumni_id already exists, show error message
        echo "<script>alert('Error: The email or kld email or alumni ID is already registered. Please use a different one.');</script>";
    } else {
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" placeholder="ex. juan@gmail.com" name="email" required maxlength="100">
                </div>

                <div class="form-group">
                    <label for="alumni_id">Alumni ID:</label>
                    <input type="text" class="form-control" id="alumni_id" name="alumni_id" placeholder="ex. KLDAA-202499999" required maxlength="50" pattern="^[A-Za-z]{5}-\d{9}$" title="Alumni ID must follow the format: 5 letters followed by a hyphen and 9 digits (e.g., KLDAA-202400051).">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kld_email" name="kld_email"  placeholder="ex.jane.doe@kld.edu.ph" maxlength="100">
                </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="primary_phone" name="primary_phone" maxlength="11" placeholder="ex.09123456789" pattern="^\d{11,11}$" title="Phone number must be 11 digits.">
                </div>

                <div class="form-group">
                    <label for="secondary_phone">Secondary Phone:</label>
                    <input type="text" class="form-control" id="secondary_phone" name="secondary_phone" maxlength="11" placeholder="ex.09123456789" pattern="^\d{11,11}$" title="Phone number must be 11 digits.">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="graduation_year" placeholder="ex. 2024" name="graduation_year" min="2000" max="2024" required>
                </div>
            </div>
